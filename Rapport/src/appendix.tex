...
\label{apx:Kravspec}
\includepdf[pages={-}]{appendix/Kravspecifikation_v07.pdf}

\section{Projektplan}
\label{apx:Projektplan}
\includepdf[pages={-}]{appendix/Projektplan_v03.pdf}

\section{Kodstandard}
\label{apx:Kodstandard}
\includepdf[pages={-}]{appendix/kodstandard.pdf}
...
\begin{figure}[htbp!]
\centering
\includegraphics{../../includes/figures/PSU_PCB}
